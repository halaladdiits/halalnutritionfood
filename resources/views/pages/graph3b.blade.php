...
@section('body')
    <!--<div class="container">-->
        ...
        <div id="d3_selectable_force_directed_graph" style="width: 1226px; height: 500px; margin: auto;">
		...
		Show : <select onchange="window.location=this.options[this.selectedIndex].value">
			  ...
			  <option value="http://halal.addi.is.its.ac.id/graph3d">40</option>
...
var svg = d3.select('#d3_selectable_force_directed_graph');
    ...
    d3.json('graphvis/graphvis3/graphvis3b.json', function(error, graph) {
        if (!error) {
