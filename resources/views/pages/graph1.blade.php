...
@section('body')
    <!--<div class="container">-->
        <div id="mySidenav" class="sidenav">
		  ...
		  <h4>Hints</h4>
		  <img src="graphvis/img/green.jpg">= Food Product</img><br>
		...
		Show : <select onchange="window.location=this.options[this.selectedIndex].value">
			  ...
			  <option value="http://halal.addi.is.its.ac.id/graph1a">10</option>
...
var svg = d3.select('#d3_selectable_force_directed_graph');
    ...
    d3.json('graphvis/graphvis1/graphvis1.json', function(error, graph) {
        if (!error) {
